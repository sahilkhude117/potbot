...
const INSTRUCTION_DISCRIMINATORS = {
  initializePot: Buffer.from([169, 131, 191, 237, 122, 135, 203, 67]), 
  addTrader: Buffer.from([31, 161, 110, 235, 39, 57, 68, 229]),       
  removeTrader: Buffer.from([123, 134, 200, 251, 206, 117, 61, 216]),
  deposit: Buffer.from([242, 35, 198, 137, 82, 225, 242, 182]),      // deposit discriminator
  redeem: Buffer.from([184, 12, 86, 149, 70, 196, 97, 225]),         // redeem discriminator
};
